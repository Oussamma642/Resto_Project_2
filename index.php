...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="#BookTab" class="btn btn-primary py-2 px-4">Book A Table</a>
                </div>
            </nav>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="#BookTab" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Book A
                                Table</a>
                        </div>
        ...
        <iframe id="chatbot-frame"
            src="https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2024/12/19/21/20241219215016-DN7EF1IS.json"
        ...
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div id="BookTab" class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date" data-target-input="nearest">
                                        <input name="date" type="date" class="form-control datetimepicker-input"
                                            id="date" placeholder="Date" data-target="#date"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating time" id="time" data-target-input="nearest">
                                        <input name="time" type="time" class="form-control datetimepicker-input"
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit" name="reserver">Book
                                        Now</button>
                                </div>
                            </div>
                        </form>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <a class="btn btn-link" href="boooking.php">Reservation</a>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Contact</h4>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>123 Street, Marrakech, Morocco</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+212596985</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">OWFS-202</a>
